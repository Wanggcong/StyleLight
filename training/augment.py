...
class AugmentPipe(torch.nn.Module):
    def __init__(self,
        ...
        noise=0, cutout=0, noise_std=0.1, cutout_size=0.5, cyclic =0
    ):
        super().__init__()
    ...
    def forward(self, images, debug_percentile=None, isRealImage=False):
